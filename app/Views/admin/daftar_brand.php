      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="border-radius: 5px">
          <div class="modal-body">
            ...
            <div class="row mb-2">
              <a class="btn" href="<?= base_url('admin/hapusBrand/'.$val->id_brand) ?>" style="background: #460137; color: white; margin-left: auto; margin-right: 10px; width: 105px; padding: 10px">Yakin</a>
