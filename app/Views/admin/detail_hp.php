...
<div class="col-lg-10 mt-4" style="left: 225px">
	<div class="row mt-3">
	...
	<div class="row mt-3">
		<div class="col-lg-6">
			...
			<div class="form-group">
				...
				<input value="<?= $database->tgl_rilis ?>" class="form-control" readonly disabled>
			</div>
		...
		<div class="col-lg-6">
			...
			<div class="form-group">
				<label>Harga</label>
				<input value="<?= $database->harga ?>" class="form-control" readonly disabled>
			</div>
